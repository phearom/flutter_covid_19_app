...
class _AccountWidgetState extends State<AccountWidget> with SingleTickerProviderStateMixin {
  Token _paymentToken;
  ...
  final CreditCard testCard = CreditCard(number: '4000002760003184', expMonth: 12, expYear: 21, cvc: '234');
              ...
              onPressed: () {
                StripePayment.paymentRequestWithCardForm(CardFormPaymentRequest()).then((paymentMethod) {
                  _scaffoldKey.currentState.showSnackBar(
                    SnackBar(
                      content: Text('Received ${paymentMethod.id}-${paymentMethod.card.cardId}'),
                    ),
                  );
                  setState(() {
